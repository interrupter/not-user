...
module.exports = ({
  ...
  describe('sendPasswordResetCode', function() {
    it('ok', async () => {
      const user = {
      ...
      notNode.Application = stubApp({
        ...
        async inform(params) {
          ...
          expect(codeData.payload.action).to.be.equal('userPasswordReset');
        }
      });
      await MailerLogics.UserMailer.sendPasswordResetCode({
        user
      });
    });
