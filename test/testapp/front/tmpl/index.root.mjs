...
import * as mod_0
from '/home/cypher/proj/not-lib/not-user/node_modules/not-options/src/controllers/root';
...
import * as mod_3
from '/home/cypher/proj/not-lib/not-user/node_modules/not-notification/src/controllers/root';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_3,
  services, uis, wsc, fields
...
import * as mod_5
from '/home/cypher/proj/not-lib/not-user/node_modules/not-inform/src/controllers/root';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_5,
  services, uis, wsc, fields
...
import * as mod_6
from '/home/cypher/proj/not-lib/not-user/node_modules/not-inform-rule-tag/src/controllers/root';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_6,
  services, uis, wsc, fields
...
import * as mod_7
from '/home/cypher/proj/not-lib/not-user/node_modules/not-inform-sink-email/src/controllers/root';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_7,
  services, uis, wsc, fields
...
import * as mod_8
from '/home/cypher/proj/not-lib/not-user/node_modules/not-inform-sink-notification/src/controllers/root';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_8,
  services, uis, wsc, fields
...
import * as mod_9
from '/home/cypher/proj/not-lib/not-user/node_modules/not-key/src/controllers/root';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_9,
  services, uis, wsc, fields
...
import * as mod_14
from '/home/cypher/proj/not-lib/not-user/test/testapp/front/src/root/main';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_14,
  services, uis, wsc, fields
