...
import * as mod_2
from '/home/cypher/proj/not-lib/not-user/node_modules/not-notification/src/controllers/user';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_2,
  services, uis, wsc, fields
...
import * as mod_8
from '/home/cypher/proj/not-lib/not-user/test/testapp/front/src/user/main';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_8,
  services, uis, wsc, fields
