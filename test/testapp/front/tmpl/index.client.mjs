...
import * as mod_2
from '/home/cypher/proj/not-lib/not-user/node_modules/not-notification/src/controllers/client';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_2,
  services, uis, wsc, fields
...
import * as mod_8
from '/home/cypher/proj/not-lib/not-user/test/testapp/front/src/client/main';
appDefaultOptions = notCommon.absorbModule({
  defaultConf: appDefaultOptions,
  mod: mod_8,
  services, uis, wsc, fields
