...
{:else}
    {#if title.__enabled}
        <h5 class="title">
            {title[mode]}
            {#if mode === "update"}{user.userID}#{user.username}{/if}
        </h5>
    {/if}
    {#if own}
    ...
    <div class="container">
        {#if fields.username.enabled}
            <div class="field user-form-field user-login-form-username">
                <label class="label" for="user-login-form-username"
                ...
                <p
                    class="help {usernameClasses}"
                    id="input-field-helper-username"
                >
        ...
        {#if fields.email.enabled}
            <div class="user-form-field user-login-form-email field">
                <label class="label" for="user-login-form-email"
        ...
        {#if fields.password.enabled}
            <div class="field user-form-field user-login-form-password">
                <label for="user-login-form-password" class="label"
                ...
                <p
                    class="help {passwordClasses}"
                    id="input-field-helper-password"
                >
        ...
        {#if fields.password2.enabled}
            <div class="field user-form-field user-login-form-password2">
                <label class="label" for="user-login-form-password2"
                    >{fields.password2.label}</label
                >
                <div class="control has-icons-left has-icons-right">
                    <input
                        id="user-login-form-password2"
                        class="input {password2Classes}"
                        type="password"
                        name="password2"
                        invalid={validationErrors.password2}
                ...
                <p
                    class="help {password2Classes}"
                    id="input-field-helper-password2"
                >
        ...
        {#if fields.tel.enabled}
            <div class="field user-form-field user-login-form-tel">
                <label class="label" for="user-login-form-tel"
                    >{fields.tel.label}</label
                >
                <div class="control has-icons-left has-icons-right">
                    <input
        ...
        {#if errorMessage != false}
            <div class="user-form-error notification is-danger">
                {errorMessage}
            </div>
        {/if}
        ...
        {#if fields.role.enabled}
            <div class="user-form-field user-login-form-role field">
                <label class="label" for="user-login-form-role"
                    >{fields.role.label}</label
                >
                <div class="control {roleClasses}" id="user-login-form-role">
                    <UITagSelect
                        variants={UserCommon.ROLES}
                        bind:error={roleInvalid}
                        on:change={onRoleChange}
                        bind:items={userRoles}
                    />
                </div>
        ...
        {#if fields.country.enabled}
            <div class="user-form-field user-login-form-country field">
                <label class="label" for="user-login-form-country"
                ...
                <p
                    class="help {countryClasses}"
                    id="input-field-helper-country"
                >
